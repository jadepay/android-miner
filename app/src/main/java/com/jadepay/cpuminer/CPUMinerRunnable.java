...
public class CPUMinerRunnable implements Runnable {
	...
	public void run() {
		...
		wakeLock = mgr.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "com.jadepay.cpuminer.WakeLock");
		wakeLock.acquire();
		...
		if (mWifi.isConnected()) {
			...
			wifiLock = wm.createWifiLock(WifiManager.WIFI_MODE_FULL , "com.jadepay.cpuminer.WifiLock");
			wifiLock.acquire();
		}
