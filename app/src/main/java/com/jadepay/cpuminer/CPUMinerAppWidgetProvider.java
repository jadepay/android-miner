...
public class CPUMinerAppWidgetProvider extends AppWidgetProvider {
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (extras != null && extras.containsKey("com.jadepay.cpuminer.logEntry")) {
			LogEntry entry = intent.getParcelableExtra("com.jadepay.cpuminer.logEntry");
			lastEntry = entry;
		}
	...
	public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        intent.setComponent(new ComponentName("com.jadepay.cpuminer",
            "com.jadepay.cpuminer.MainActivity"));
