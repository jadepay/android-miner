...
int cpuminer_start(int argc, char *argv[])
{
	struct thr_info *thr;
	long flags;
	int i;
	...
	printf("\xBA  Jadepay cpu-miner (v1.2c)                      \xBA\n");
	printf("\xBA  algo: Jad8                                \xBA\n");
	printf("\xBA  http://www.jadepay.org                          \xBA\n");
