...
jint Java_com_jadepay_cpuminer_CPUMinerApplication_startMiner(JNIEnv * env, jobject this, jint number, jstring parameters)
{
	jboolean isCopy;
...
void Java_com_jadepay_cpuminer_CPUMinerApplication_stopMiner(JNIEnv * env, jobject this)
{
	stop_miner();
}

extern long get_accepted(void);
jlong Java_com_jadepay_cpuminer_CPUMinerApplication_getAccepted(JNIEnv * env, jobject this)
{
	return get_accepted();
}

extern long get_rejected(void);
jlong Java_com_jadepay_cpuminer_CPUMinerApplication_getRejected(JNIEnv * env, jobject this)
{
	return get_rejected();
}

extern int get_threads(void);
jint Java_com_jadepay_cpuminer_CPUMinerApplication_getThreads(JNIEnv * env, jobject this)
{
	return get_threads();
}

extern double get_hash_rate(int cpu);
jdouble Java_com_jadepay_cpuminer_CPUMinerApplication_getHashRate(JNIEnv * env, jobject this, jint cpu)
{
